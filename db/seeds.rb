...
post2 = Post.new(user_id: user2.id, animal_id: animal1.id, address: "Cl. 18A #77-10", description: "Hola me llamo Orion y me perdí la noche del 12 de octubre, si me has visto por favor comunicate con mis padres humanos.", post_type: true, status: "Contactado", reward: true)
...
post3 = Post.new(user_id: user3.id, animal_id: animal.id, address: "Cl. 16 #75-6", description: "Me he perdido. Por favor, si encuentras este peludito o piensas que lo has visto, contacte con nosotros ", post_type: true, status: "Contactado", reward: true)
