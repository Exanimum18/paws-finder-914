...
puts "Creando posts..."
post = Post.new(title: "Perro perdido parque Belen", user_id: user.id, animal_id: animal.id, address: "Cl. 25 #73-28", description: "Se me perdio mi perro la noche del 11 de octubre en el parque cerca a la carrera 72 en Belén Sanbernardo.", post_type: true, status: "Contactado", reward: true)
...
post1 = Post.new(title: "Gato perdido Biblioteca Belen" , user_id: user1.id, animal_id: animal1.id, address: "Cra. 79 #18-19", description: "Buenas noches, mi gato Bigotes se perdio en la madrugada de 13 de octubre cerca al parque biblioteca de Belén, si tienen alguna información por favor contactarse conmigo, muchas gracias.", post_type: true, status: "Contactado", reward: true)
...
post2 = Post.new(title: "SE PERDIO EL 12 OCT", user_id: user2.id, animal_id: animal1.id, address: "Cl. 18A #77-10", description: "Hola me llamo Orion y me perdí la noche del 12 de octubre, si me has visto por favor comunicate con mis padres humanos.", post_type: true, status: "Contactado", reward: true)
...
post3 = Post.new(title: "Perro perdido", user_id: user3.id, animal_id: animal.id, address: "Cl. 16 #75-6", description: "Me he perdido. Por favor, si encuentras este peludito o piensas que lo has visto, contacte con nosotros ", post_type: true, status: "Contactado", reward: true)
...
post4 = Post.new(title: "Gatita perdida por La Playas", user_id: user4.id, animal_id: animal1.id, address: "Cl. 18 #70-25", description: "Mi gatita salíó de casa y no ha regresado, estamos muy angustiados. 😢 Sucedió en la Cl 18 Belén las playas, el 16 de octubre", post_type: true, status: "Contactado", reward: true)
...
post5 = Post.new( title: "Perrito encontrado Juan pablo II", user_id: user5.id, animal_id: animal.id, address: "Cl. 16 #75-6", description: "Se encontro este hermoso Yorki en la Cra. 70, cerca al Parque Juan Pablo II, se encuentra bien de salud.", post_type: false, status: "Encontrado", reward: false)
